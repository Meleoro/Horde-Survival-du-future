...
public class ButtonChoice : MonoBehaviour
{
    ...
    public void ButtonPressed()
    {
        ...
        if (ChoiceManager.Instance.currentLevel == ChoiceManager.Instance.secondWeaponLevel || ChoiceManager.Instance.currentLevel == ChoiceManager.Instance.thirdWeaponLevel)
        {
